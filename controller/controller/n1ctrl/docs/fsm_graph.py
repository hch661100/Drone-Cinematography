...
n1_graph = Digraph('n1_graph')
n1_graph.attr('graph', packMode='graph')
...
n1_graph.node('JS_DIRECT', 'Joystick direct control', **node_style)
n1_graph.node('JS_CTRL_RAW', 'Joystick control without odom', **node_style)
